...
com_ptr<IDeckLinkDisplayMode> get_display_mode(const com_iface_ptr<IDeckLinkInput>& device, BMDDisplayMode format, BMDPixelFormat pix_fmt, BMDSupportedVideoModeFlags flag)
{
...
get_display_mode(const com_iface_ptr<IDeckLinkInput>& device, core::video_format fmt, BMDPixelFormat pix_fmt, BMDSupportedVideoModeFlags flag)
{
