...
class image_mixer final : public core::image_mixer
{
  public:
    ...
    core::const_frame finish_frame(const void* video_stream_tag, const struct core::pixel_format_desc& desc, std::vector<caspar::array<std::uint8_t>> image_data) override;
